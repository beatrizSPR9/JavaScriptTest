...
// The reduce method iterates through each employee and accumulates their 
// salaries to calculate the total. The initial value of the accumulator 
// (acc) is 0
...
function findEmployeeByEsp(employeeEsp) {
